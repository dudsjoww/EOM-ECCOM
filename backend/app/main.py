...
from app.api import routes_usuarios, routes_tatuadores, routes_pedidos, routes_horarios, routes_todos_os_horarios, routes_estoque
...
app.include_router(routes_orcamento.router)
app.include_router(routes_orcamento_consumiveis.router)
app.include_router(consumo_itens.router)
app.include_router()
